...
<br/>
<pre>[root@server1 ~]# grep route /etc/init.d/network<br/> # Add non interface-specific static-routes.<br/> if [ -f /etc/sysconfig/static-routes ]; then<br/>    grep "^any" /etc/sysconfig/static-routes | while read ignore args ; do<br/>              /sbin/route add -$args</pre>
<br/>
...
<br/>
<br/>
<pre>[root@server1 sysconfig]# cat static-routes <br/>any net 192.168.100.0 netmask 255.255.255.0 gw 192.168.122.1 dev eth0</pre>
<br/>
...
<br/>
<br/>
<pre class="crayon-selected">[root@server1 network-scripts]# cat route-eth0 <br/>192.168.100.0/24 via 192.168.122.1 dev eth0</pre>