...
Alright, so this is a little more in depth than creating a simple package, but I figured I could fulfill the Red Hat requirement and create a little bit of documentation on how to create the rpm for OpenNHRP in one swoop. :)
